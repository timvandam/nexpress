...
// Server status
const SERVER_STATUS = { version: { name: '1.15.2!', protocol: 578 }, players: { max: 321, online: 123, sample: [] }, description: { text: 'Hello World!', color: 'green', bold: true } }

// Disconnect message
const DISCONNECT_MSG = { text: 'Made with Nexpress!', color: 'yellow', bold: true }

// Set the default socket state to Handshaking
packetHandler.use((data, res, next) => {
